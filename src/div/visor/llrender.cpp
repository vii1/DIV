...
// Datos cambiantes
  ...
  llrender_struct->fin_copia=llrender_struct->copia+llrender_struct->vancho*llrender_struct->alto_pantalla;
...
*/
  ...
  if(zmed<llrender_struct->mmdist[0])
    ...
    if(zmed<llrender_struct->mmdist[1])
      mmlvl=1;
    else
      if(zmed<llrender_struct->dist_max)
	      mmlvl=2;
      else
	      mmlvl=3;
  ...
  switch (face->tipo_map) {
    ...
    case ANTIALIAS:
      ...
      break;
    case GOURAUD:
      llrender_Pinta_Triangulo(llrender_struct,face,mmlvl,T_GOURAUD);
      break;
    case TEXTURA:
      llrender_Pinta_Triangulo(llrender_struct,face,mmlvl,T_TEXTURA);
      break;
    case TEXT_GOUR:
      llrender_Pinta_Triangulo(llrender_struct,face,mmlvl,T_TEXTURA | T_GOURAUD);
      break;
    case TEXT_ILUM:
//      Pinta_Text_Ilum(face,mmlvl);
//      llrender_Pinta_Triangulo(llrender_struct,face,mmlvl,T_TEXTURA | T_TRANSLUCIDO);
      break;
    case TEXT_PER:
      llrender_Pinta_Triangulo(llrender_struct,face,mmlvl,T_TEXTURA | T_PERSPECTIVA);
      break;
    case TEXT_PER_TRANS:
//      Pinta_Text_Persp_Translucido(face,mmlvl);
    ...
    case SOMBRA:
      ...
      break;
    case TRANS_PER:
      llrender_Pinta_Triangulo(llrender_struct,face,mmlvl,T_TEXTURA | T_PERSPECTIVA | T_MASCARA);
      break;
    case TEXT_BILINEAR:
//      Pinta_Text_Persp_Bilinear(face,mmlvl);
      break;
    case TRANSPARENTE:
      llrender_Pinta_Triangulo(llrender_struct,face,mmlvl,T_TEXTURA | T_MASCARA);
      break;
    case TRANSPARENTE_MASCARA:
      llrender_Pinta_Triangulo(llrender_struct,face,mmlvl,T_TEXTURA | T_TRANSLUCIDO | T_MASCARA);
      break;
    case FLAT_TRANS:
      llrender_Pinta_Triangulo(llrender_struct,face,mmlvl,T_FLAT | T_TRANSLUCIDO);
      break;
    case GOUR_MASK:
      llrender_Pinta_Triangulo(llrender_struct,face,mmlvl,T_TEXTURA | T_MASCARA | T_GOURAUD);
      break;
  }
...
void llrender_clipping_3d_near(llrender *llrender_struct,lptface face_in)
{
  ...
  if (i==2) { // El resultado del corte es un tri ngulo
    ...
    // Proyectar
    vertex[1].fpx=(llrender_struct->fancho_pantalla/2)+(vertex[1].sx*llrender_struct->proyeccion_x);
    vertex[1].fpy=(llrender_struct->falto_pantalla/2)-(vertex[1].sy*llrender_struct->proyeccion_y);
    vertex[1].fpz=1.0;
    vertex[1].sutherland_cohen=0;
    if (vertex[1].fpx<0.0) vertex[1].sutherland_cohen+=1;
    if (vertex[1].fpx>llrender_struct->fancho_pantalla) vertex[1].sutherland_cohen+=4;
    if (vertex[1].fpy<0.0) vertex[1].sutherland_cohen+=16;
    if (vertex[1].fpy>llrender_struct->falto_pantalla) vertex[1].sutherland_cohen+=64;
    ...
    // Proyectar
    vertex[2].fpx=(llrender_struct->fancho_pantalla/2)+(vertex[2].sx*llrender_struct->proyeccion_x);
    vertex[2].fpy=(llrender_struct->falto_pantalla/2)-(vertex[2].sy*llrender_struct->proyeccion_y);
    vertex[2].fpz=1.0;
    vertex[2].sutherland_cohen=0;
    if (vertex[2].fpx<0.0) vertex[2].sutherland_cohen+=1;
    if (vertex[2].fpx>llrender_struct->fancho_pantalla) vertex[2].sutherland_cohen+=4;
    if (vertex[2].fpy<0.0) vertex[2].sutherland_cohen+=16;
    if (vertex[2].fpy>llrender_struct->falto_pantalla) vertex[2].sutherland_cohen+=64;
    ...
    // Proyectar
    vertex[3].fpx=(llrender_struct->fancho_pantalla/2)+(vertex[3].sx*llrender_struct->proyeccion_x);
    vertex[3].fpy=(llrender_struct->falto_pantalla/2)-(vertex[3].sy*llrender_struct->proyeccion_y);
    vertex[3].fpz=1.0;
    vertex[3].sutherland_cohen=0;
    if (vertex[3].fpx<0.0) vertex[3].sutherland_cohen+=1;
    if (vertex[3].fpx>llrender_struct->fancho_pantalla) vertex[3].sutherland_cohen+=4;
    if (vertex[3].fpy<0.0) vertex[3].sutherland_cohen+=16;
    if (vertex[3].fpy>llrender_struct->falto_pantalla) vertex[3].sutherland_cohen+=64;
    ...
    // Proyectar
    vertex[0].fpx=(llrender_struct->fancho_pantalla/2)+(vertex[0].sx*llrender_struct->proyeccion_x);
    vertex[0].fpy=(llrender_struct->falto_pantalla/2)-(vertex[0].sy*llrender_struct->proyeccion_y);
    vertex[0].fpz=1.0;
    vertex[0].sutherland_cohen=0;
    if (vertex[0].fpx<0.0) vertex[0].sutherland_cohen+=1;
    if (vertex[0].fpx>llrender_struct->fancho_pantalla) vertex[0].sutherland_cohen+=4;
    if (vertex[0].fpy<0.0) vertex[0].sutherland_cohen+=16;
    if (vertex[0].fpy>llrender_struct->falto_pantalla) vertex[0].sutherland_cohen+=64;
...
void llrender_clipping_3d_right(llrender *llrender_struct,lptface face_in)
{
  ...
  if (i==1) { // El resultado del corte son dos tri ngulos
    ...
    dos_z=1.0/vertex[2].fpz;
    // Corte 1 con el plano de clipping
    fwork=(llrender_struct->fancho_pantalla-vertex[0].fpx)/(vertex[2].fpx-vertex[0].fpx);
    ...
    // Corte 2 con el plano de clipping
    fwork=(llrender_struct->fancho_pantalla-vertex[0].fpx)/(vertex[1].fpx-vertex[0].fpx);
...
void llrender_clipping_3d_down(llrender *llrender_struct,lptface face_in)
{
  ...
  if (i==1) { // El resultado del corte son dos tri ngulos
    ...
    dos_z=1.0/vertex[2].fpz;
    // Corte 1 con el plano de clipping
    fwork=(llrender_struct->falto_pantalla-vertex[0].fpy)/(vertex[2].fpy-vertex[0].fpy);
    vertex[3].fpx=(vertex[2].fpx-vertex[0].fpx)*fwork+vertex[0].fpx;
    ...
    // Corte 2 con el plano de clipping
    fwork=(llrender_struct->falto_pantalla-vertex[0].fpy)/(vertex[1].fpy-vertex[0].fpy);
    vertex[0].fpx=(vertex[1].fpx-vertex[0].fpx)*fwork+vertex[0].fpx;
