...
void menu_programas2(void) {
  ...
  if ((old_mouse_b&1) && !(mouse_b&1)) {
    ...
    switch (v.estado) {
      ...
      case 1: // Nuevo ...
        v_modo=1; v_texto=texto[186];
      	dialogo((int)browser0);
        if (v_terminado) {
          if (!v_existe) v_aceptar=1;
          else {
            v_titulo=texto[187]; v_texto=input;
      ...
      case 3:
        if (n=determina_prg()) {
          v_titulo=texto[188]; v_texto=ventana[n].titulo;
          dialogo((int)aceptar0);
          if (v_aceptar) {
            move(0,n);
            cierra_ventana();
        ...
        if (n=determina_prg()) {
          ...
          if(numero_error!=-1) {
            ...
            if (f!=NULL) {
              ...
              v_texto=texto[238]; dialogo((int)err0);
            }
          }
        } break;
...
void save_prg_buffer(int n) { // Actualiza el programa, guarda la lกnea actual
  wup(n);
  write_line(); read_line();
  wdown(n);
}
...
void menu_mapas2(void) {
  ...
  if ((old_mouse_b&1) && !(mouse_b&1)) {
    ...
    switch (v.estado) {
      ...
      case 3: // Cerrar mapa
        if (n=determina_mapa()) {
          v_titulo=texto[50]; v_texto=ventana[n].titulo;
          dialogo((int)aceptar0);
          if (v_aceptar) {
      ...
      case 4: // Cerrar todos los mapas (maximizados)
        v_titulo=texto[334]; v_texto=texto[335];
        dialogo((int)aceptar0);
        if (v_aceptar) {
      ...
      casi_no_tiene_nombre:
          ...
          if (v_terminado) {
            if (v_existe) {
              v_titulo=texto[52]; v_texto=input;
              dialogo((int)aceptar0);
            } else v_aceptar=1;
            if (v_aceptar) {
              mouse_graf=3; volcado_copia(); mouse_graf=1;
      ...
      case 8: // Crear el mapa de bฃsqueda
        mapa_busqueda(); break;
        ...
        if (n=determina_mapa()) {
          ...
          if (v.primer_plano==0) {
            for (m=1;m<max_windows;m++) if (ventana[m].tipo && ventana[m].primer_plano==1)
              if (colisionan(0,m)) {ventana[m].primer_plano=0; vuelca_ventana(m);}
            v.primer_plano=1;
          } mouse_b=1; call(v.click_handler);
        } break;
      ...
      case 11:
        if (cpu_type==5) generador_sprites();
          ...
          v_texto=texto[391]; dialogo((int)err0);
        }
        break;
  ...
  if ((old_mouse_b&1) && !(mouse_b&1)) {
    ...
    switch (v.estado) {
      ...
      case 3: // Cerrar fichero
        if (n=determina_fpg()) {
          v_titulo=texto[81]; v_texto=ventana[n].titulo;
          dialogo((int)aceptar0);
          if (v_aceptar) {
            free(ventana[n].aux);
            move(0,n); cierra_ventana();
          ...
          if (v_terminado) {
            if (v_existe) {
              ...
              if (!strcmp(full,Fpg->ActualFile)) {
                ...
                v_titulo=texto[82]; v_texto=input;
                dialogo((int)aceptar0);
              }
...
void menu_fuentes2(void) {
  ...
  if ((old_mouse_b&1) && !(mouse_b&1)) {
    switch (v.estado) {
      ...
      case 4:
        if (n=determina_fnt()) {
          FntAux=ventana[n].aux+RES_FOR_NAME;
...
void imp_fontmap(void) {
  ...
  if (v_existe) {
    v_titulo=texto[75]; v_texto=texto[76];
  ...
  if ((buffer=(char*)malloc(buffer_len))==NULL) {
    v_texto=texto[45]; dialogo((int)err0); return; // Not enought memory, close ...
  }
  ...
  if (chars!=256) { v_texto=texto[243]; dialogo((int)err0); free(buffer); return; }
  ...
  if (*(int*)(buffer+1356+'ค'*16)) gencode|=16;

  memcpy(buffer+1352,&gencode,4);

  if ((f=fopen(FontPathName,"wb"))==NULL) {
    v_texto=texto[242]; dialogo((int)err0);
    free(buffer); return;
  }
...
void gen_fontmap(void) {
  ...
  if (v_mapa!=NULL && v_mapa->map!=NULL) {
    ...
    // Ojo! calcular "c4" como un color !=0 !=c4 que no est
...
//int x;
  ...
  if ((old_mouse_b&1) && !(mouse_b&1)) {
    switch (v.estado) {
      ...
      case 3:
        if (n=determina_pcm()) {
          v_titulo=texto[338]; v_texto=ventana[n].titulo;
          dialogo((int)aceptar0);
      ...
      no_tiene_nombre_sonido:
        if (n=determina_pcm()) {
          v_tipo=7; v_modo=1; v_texto=texto[339];
          dialogo((int)browser0);
          if (v_terminado) {
            if (v_existe) {
...
//              wup(n); repinta_ventana(); wdown(n); vuelca_ventana(n);
      ...
      case 9:
        if (n=determina_mod()) {
          v_titulo=texto[513]; v_texto=ventana[n].titulo;
          dialogo((int)aceptar0);
          if (v_aceptar) { move(0,n); cierra_ventana(); }
        } break;
        break;
...
void menu_sistema2(void) {
  actualiza_menu(875,1,0); if ((old_mouse_b&1) && !(mouse_b&1)) {
    switch (v.estado) {
      ...
      case 10: shell(); break;
      case 11:
        v_titulo=texto[40]; v_texto=NULL; dialogo((int)aceptar0);
...
// Una ventana de tipo "mapa" requiere la siguiente informaciขn (tanto si se
// carga un mapa como si se crea nuevo en el programa)

// v_mapa->filename   ฤฟ Estos dos primeros campos ser n "Mapa x",NULL si
// v_mapa->path       ฤู el mapa no tiene una correspondencia aฃn en disco
// v_mapa->map
// v_mapa->mab
// v_mapa->map_an/al
...
void mapa0(void) {
  ...
  v.titulo=v.mapa->filename;
  v.nombre=v.mapa->filename;
...
extern struct _thumb_tex {
  int an,al;            // Ancho y Alto de la reducciขn
...
void mapa2(void) {
  ...
  if ((mouse_b&1)) {
    ...
    mab=malloc(((map_an*map_al+31)/32)*4);
...
void usuario0(void) {
  ...
  _get(460,4+86,22,v.an-8-86,user1,127,0,0);
...
void copyright0(void) {
  ...
  if (CopiaDesktop) {
    ...
    _button(457,48+48+3,v.al-16,0); // Nueva sesiขn
  } else {
    _button(457,v.an-11,v.al-16,2); // Nueva sesiขn
  }
}
...
void copyright1(void) {
  ...
  wwrite_in_box(v.ptr,an,an-9,al,99,25,0,user1,c1);
  wwrite_in_box(v.ptr,an,an-9,al,98,25,0,user1,c23);
  wwrite_in_box(v.ptr,an,an-9,al,99,25+8,0,user2,c1);
  wwrite_in_box(v.ptr,an,an-9,al,98,25+8,0,user2,c23);
...
void err0(void) {
  ...
  v.an=text_len(v_texto)+8; v.al=38; // Ojo: error_window=malloc(640*38*2)
...
void test1(void) {
  int an=v.an/big2,al=v.al/big2;
  _show_items();
  wwrite(v.ptr,an,al,5,12,0,v_texto,c1);
  wwrite(v.ptr,an,al,4,12,0,v_texto,c3);
}
...
void test0(void) {
  ...
  v_texto=texto[383];
  v.an=text_len(v_texto)+9; v.al=38;
...
void aceptar0(void) {
  ...
  if (v_titulo!=NULL) { v.titulo=v_titulo;
    if (text_len(v_titulo)+14>v.an) v.an=text_len(v_titulo)+14; }
  if (v_texto!=NULL) { v.al=38;
    if (text_len(v_texto)+6>v.an) v.an=text_len(v_texto)+6;
  } else v.al=29;
...
void aceptar1(void) {
  int an=v.an/big2,al=v.al/big2;
  _show_items();
  if (v_texto!=NULL) wwrite(v.ptr,an,al,an/2,12,1,v_texto,c3);
}
...
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
//      Cuadro de di logo para tratar paleta al abrir con v_titulo y/o v_texto
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
...
void TratarPaleta1(void) {
  ...
  if (OpcPal[1]) {
    ...
    wwrite(v.ptr,an,al,an/2+1,14,1,"+",c0);
    wwrite(v.ptr,an,al,an/2,14,1,"+",c4);
  }
...
void pinta_listbox(struct t_listbox * l) {
  ...
  if (n=l->maximo) { // Si hay elementos en la lista
    ...
    do {
      wwrite_in_box(ptr+(l->x+2)*big2,an,l->an-4,al,0,y,0,p,c3);
      p+=l->lista_an; y+=8;
    } while (--n);
  }
  ...
  if (l->zona>=10) { // Marca zona
    wwrite_in_box(ptr+(l->x+2)*big2,an,l->an-4,al,0,l->y+2+(l->zona-10)*8,0,
      l->lista+l->lista_an*(l->inicial+l->zona-10),c4); v.volcar=1;
  }
...
void actualiza_listbox(struct t_listbox * l) {
  ...
  if (old_zona!=l->zona) if (old_zona>=10) { // Desmarca zona
    wwrite_in_box(ptr+(l->x+2)*big2,an,l->an-4,al,0,l->y+2+(old_zona-10)*8,0,
      l->lista+l->lista_an*(l->inicial+old_zona-10),c3); v.volcar=1;
  }
  ...
  if (_fullpath(full,input,_MAX_PATH)!=NULL) {
    ...
    if (full[0]==drive[0]) {
      ...
      if (!strlen(dir) || !chdir(dir)) {
        ...
        // si tiene comodines
        //   si no se convierte en ningฃn fichero, lo toma como nueva m scara
        //   si se convierte en un fichero, expande su nombre a input (editando)
        //   si se convierte en m s de uno, lo toma como nueva m scara
...
void nuevo_mapa0(void) {
  ...
  _get(133,4,12,v.an-72,mancho,8,1,32767);
  _get(134,4,34,v.an-72,malto,8,1,32767);
...
//      v.item[0].estado&=-3; v.item[1].estado&=-3; // Evitar "out of range"
      call(v.paint_handler); actualiza_listbox(&lmapsizes);
...
int nuevo_mapa(byte * mapilla) {
  ...
  // 1ง Pide memoria para un struct tmapa
  if ((v_mapa=malloc(sizeof(struct tmapa)))!=NULL) {

    // 2ง Pide memoria para el mapa

    if (mapilla!=NULL) v_mapa->map=mapilla; else v_mapa->map=malloc(map_an*map_al);

    if (v_mapa->map!=NULL) {

      if (mapilla==NULL) {
        // 2งB Pone el mapa a cero
        memset(v_mapa->map,0,map_an*map_al);
      }

      // 4ง Fija el resto de variables
    ...
    } else { v_texto=texto[45]; dialogo((int)err0); free(v_mapa); }
...
//int filesize;
  ...
  if (sum)
  {
    dialogo((int)TratarPaleta0); // จCargar paleta?
      ...
      if ((f=fopen(full,"rb"))!=NULL) { // Se ha elegido uno
        ...
        if ((buffer=malloc(n))!=NULL) {
          ...
          if (fread(buffer,1,n,f)==n) {
            ...
            if (tipomapa) {
              if ((v_mapa=malloc(sizeof(struct tmapa)))!=NULL) {
                if ((v_mapa->map=malloc(map_an*map_al+map_an))!=NULL) {
...
void guardar_mapa(void) {
  ...
  if (strchr(input,' ')==NULL) {
    if ((f=fopen(full,"wb"))!=NULL) { // Se ha elegido uno
      ...
      } if (e==2) { v_texto=texto[48]; dialogo((int)err0); }

      // *** OJO, se debe borrar el fichero si no se pudo grabar entero

      fclose(f);

    } else { v_texto=texto[47]; dialogo((int)err0); e=1; }
  } else { v_texto=texto[47]; dialogo((int)err0); e=1; }
...
void Tamnio0()
{
  ...
  _get(133,42,11,30,cAncho,5,1,9999);
  _get(134,42,30,30,cAlto,5,1,9999);
  Porcentajes=0;
  Gris=0;
...
//Genera la tabla de grises
        ...
        if (bufferaux==NULL) { // Esto lo aคadiข dani ...
          v_texto=texto[45];
          dialogo((int)err0);
          return;
        }
...
//Gris=1 Convierte la imagen a grises
        ...
        Progress(texto[92],map_al,map_al);

        if (nuevo_mapa(bufferaux)) {
                v_texto=texto[45];
                dialogo((int)err0);
                free(bufferaux);
                return;
...
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
//      Crea un mapa de bฃsqueda de hasta 128x128 tiles
//      usado para crear un mapa de durezas
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
...
void mapbus0() {
  ...
  texto[546]=&ctiletext[0];

  _get(546,4,11,64+40,ctile,5,mintile,maxtile);
  _get(402,4,30,64+40,ccolor,5,0,255);
...
void mapa_busqueda() {
  ...
  if (man>mal) { // Obtiene los lกmites del "tile"
  ...
  for (y=0;y<map_al*itile;y+=itile) {
    Progress(texto[404],y,map_al*itile);
  ...
  } Progress(texto[404],map_al*itile,map_al*itile);
...
char cwork[5];
        ...
        wwrite(ptr,an,al,4+(an-8)/2,(14+(al-16)/2)-2,4,cwork,c3);
}
...
void Progress0()
{
        ...
        v.titulo=ProgressTitle;
        v.nombre=ProgressTitle;
}
