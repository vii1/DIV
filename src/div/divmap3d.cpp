...
//      Mขdulo que contiene el cขdigo del mapeador
//อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
...
struct t_listbox lpared= {ANCHO_VENTANA+6+50+1,     11,DummyArrayForFakingPurposesUsedInMapper,1,6,1,6*8+2};
struct t_listbox lsector={ANCHO_VENTANA+6+50+1,11+50+1,DummyArrayForFakingPurposesUsedInMapper,1,6,1,6*8+2};
...
void map_addpoint()
{
  ...
  if (mouse_b&1 && old_but1==0 || scan_code == _SPC) {
    ...
    if (region_status==0) { // Si es el primer muro
      ...
      my_map->num_walls++;
      //-----------------------------------------------------------------------
      //  Cierra una region y la aคade a la lista
      //-----------------------------------------------------------------------
