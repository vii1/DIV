...
void put_sprite(byte * si, int x, int y, int an, int al, int xg, int yg, int ang, int size, int flags); // Put one sprite
...
#define SETUP  ((_setup  *)&mem[long_header+12+10*10+10*7+8])
#define M8     ((_m8     *)&mem[long_header+12+10*10+10*7+8+8])
