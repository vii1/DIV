...
static void emit_triangle(GLUtesselator *, tess_vertex *,
	tess_vertex *,tess_vertex *);

static void emit_triangle_with_edge_flag(GLUtesselator *,
...
void tess_tesselate(GLUtesselator *tobj)
{
	tess_contour *contour;
...
void tess_tesselate_with_edge_flag(GLUtesselator *tobj)
{
	tess_contour *contour;
