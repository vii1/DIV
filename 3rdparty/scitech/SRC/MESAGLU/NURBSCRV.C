...
static GLenum
test_nurbs_curve(GLUnurbs *nobj, curve_attribs *attribs)
{
	GLenum err;
	GLint tmp_int;
...
static GLenum
test_nurbs_curves(GLUnurbs *nobj)
{
...
static GLenum
fill_knot_structures(GLUnurbs *nobj,knot_str_type *geom_knot,
...
static GLenum
convert_curves(GLUnurbs *nobj, GLfloat **new_geom_ctrl,
...
void do_nurbs_curve( GLUnurbs *nobj)
{
