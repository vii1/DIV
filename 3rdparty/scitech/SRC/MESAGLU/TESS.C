...
extern void tess_test_polygon(GLUtesselator *);
extern void tess_find_contour_hierarchies(GLUtesselator *);
extern void tess_handle_holes(GLUtesselator *);
extern void tess_tesselate(GLUtesselator *);
extern void tess_tesselate_with_edge_flag(GLUtesselator *);
static void delete_contours(GLUtesselator *);
...
void tess_call_user_error(GLUtesselator *tobj,
	GLenum gluerr)
{
...
void APIENTRY gluTessCallback( GLUtesselator *tobj, GLenum which,
                               void (CALLBACK *fn)() )
{
	switch(which)
	{
...
void APIENTRY gluDeleteTess( GLUtesselator *tobj )
{
...
void APIENTRY gluBeginPolygon( GLUtesselator *tobj )
{
/*
	if(tobj->error!=GLU_NO_ERROR)
		return;
...
void APIENTRY gluEndPolygon( GLUtesselator *tobj )
{
...
void APIENTRY gluNextContour( GLUtesselator *tobj, GLenum type )
{
	if(tobj->error!=GLU_NO_ERROR)
		return;
	if(tobj->current_polygon==NULL)
...
void APIENTRY gluTessVertex( GLUtesselator *tobj, GLdouble v[3], void *data )
{
...
static void delete_contours(GLUtesselator *tobj)
{
	tess_polygon *polygon=tobj->current_polygon;
