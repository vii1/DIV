 ...
 * Process a GLU error.
 */
static void quadric_error( GLUquadric *qobj, GLenum error, const char *msg )
{
...
GLUquadric * APIENTRY gluNewQuadric( void )
{
   ...
   q = (GLUquadric *) malloc( sizeof(struct GLUquadric) );
   if (q) {
 ...
 */
void APIENTRY gluQuadricOrientation( GLUquadric *quadObject,
                                     GLenum orientation )
{
 ...
 */
void APIENTRY gluQuadricCallback( GLUquadric *qobj,
...
void APIENTRY gluQuadricTexture( GLUquadric *quadObject,
...
void APIENTRY gluCylinder( GLUquadric *qobj,
...
void APIENTRY gluSphere( GLUquadric *qobj,
...
void APIENTRY gluDisk( GLUquadric *qobj,
