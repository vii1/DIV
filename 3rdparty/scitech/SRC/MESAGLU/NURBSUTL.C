...
GLenum
select_knot_working_range(GLUnurbs *nobj,knot_str_type *geom_knot,
...
static void
set_sampling_and_culling( GLUnurbs *nobj )
{
...
static void
revert_sampling_and_culling( GLUnurbs *nobj )
{
	if(nobj->auto_load_matrix==GL_FALSE)
	{
		glMatrixMode(GL_MODELVIEW);
...
GLenum
glu_do_sampling_3D( GLUnurbs *nobj, new_ctrl_type *new_ctrl,
...
GLenum
glu_do_sampling_uv( GLUnurbs *nobj, new_ctrl_type *new_ctrl,
	GLint **sfactors, GLint **tfactors)
{
	GLint	s_cnt, t_cnt, i;
...
GLenum
glu_do_sampling_param_3D( GLUnurbs *nobj, new_ctrl_type *new_ctrl,
	GLint **sfactors, GLint **tfactors)
{
	GLint	dim;
	GLenum	err;
...
GLenum
glu_do_sampling_2D( GLUnurbs *nobj, GLfloat *ctrl, GLint cnt, GLint order,
...
GLenum
glu_do_sampling_u( GLUnurbs *nobj, GLfloat *ctrl, GLint cnt, GLint order,
	GLint dim, GLint **factors)
{
	GLint	i;
	GLint	u_steps;
...
GLenum
glu_do_sampling_param_2D( GLUnurbs *nobj, GLfloat *ctrl, GLint cnt,
...
GLenum
glu_do_sampling_crv( GLUnurbs *nobj, GLfloat *ctrl, GLint cnt, GLint order,
	GLint dim, GLint **factors)
{
	GLenum err;
...
GLboolean
fine_culling_test_3D(GLUnurbs *nobj,GLfloat *pts,GLint s_cnt,GLint t_cnt,
...
GLboolean
fine_culling_test_2D(GLUnurbs *nobj,GLfloat *pts,GLint cnt,
