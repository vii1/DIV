...
static GLenum store_polygon_as_contour(GLUtesselator *);
static void free_current_polygon(tess_polygon *);
static void prepare_projection_info(GLUtesselator *);
static GLdouble twice_the_polygon_area(tess_vertex *,tess_vertex *);
static GLenum verify_edge_vertex_intersections(GLUtesselator *);
void tess_find_contour_hierarchies(GLUtesselator *);
static GLenum test_for_overlapping_contours(GLUtesselator *);
static GLenum contours_overlap(tess_contour *, tess_polygon *);
static GLenum is_contour_contained_in(tess_contour *,tess_contour *);
static void add_new_exterior(GLUtesselator *,tess_contour *);
static void add_new_interior(GLUtesselator *,tess_contour *,
	tess_contour *);
static void add_interior_with_hierarchy_check(GLUtesselator *,
	tess_contour *,tess_contour *);
static void reverse_hierarchy_and_add_exterior(GLUtesselator *,
	tess_contour *,tess_contour *);
static GLboolean point_in_polygon(tess_contour *,GLdouble,GLdouble);
static void shift_interior_to_exterior(GLUtesselator *,tess_contour *);
static void add_exterior_with_check(GLUtesselator *,tess_contour *,
	tess_contour *);
static GLenum cut_out_hole(GLUtesselator *,tess_contour *,
	tess_contour *);
static GLenum merge_hole_with_contour(GLUtesselator *,
	tess_contour *,tess_contour *,tess_vertex *,
	tess_vertex *);

static GLenum
find_normal(GLUtesselator *tobj)
{
...
void
tess_test_polygon( GLUtesselator *tobj )
{
	tess_polygon *polygon=tobj->current_polygon;
...
static GLenum test_for_overlapping_contours(GLUtesselator *tobj)
{
...
static GLenum store_polygon_as_contour(GLUtesselator *tobj)
{
	tess_polygon *polygon=tobj->current_polygon;
...
static void prepare_projection_info(GLUtesselator *tobj)
{
	tess_polygon *polygon=tobj->current_polygon;
...
static GLenum verify_edge_vertex_intersections(GLUtesselator *tobj)
{
	tess_polygon *polygon=tobj->current_polygon;
...
void tess_find_contour_hierarchies(GLUtesselator *tobj)
{
...
void tess_handle_holes(GLUtesselator *tobj)
{
