...
static GLenum
test_nurbs_surface(GLUnurbs *nobj, surface_attribs *attrib)
{
	GLenum err;
	GLint tmp_int;
...
static GLenum
test_nurbs_surfaces(GLUnurbs *nobj)
{
...
static GLenum
fill_knot_structures(GLUnurbs *nobj,
...
static GLenum
convert_surfs(GLUnurbs *nobj, new_ctrl_type *new_ctrl)
{
...
static void
draw_polygon_mode( GLenum display_mode, GLUnurbs *nobj,
...
#if 0
static void
draw_patch_mode( GLenum display_mode, GLUnurbs *nobj,
	new_ctrl_type *new_ctrl, GLint *sfactors, GLint *tfactors )
{
	GLsizei				offset;
	GLint				t_bezier_cnt,s_bezier_cnt;
...
GLenum
augment_new_ctrl(GLUnurbs *nobj, new_ctrl_type *p)
{
	GLsizei offset_size;
	GLint	i,j;
...
void
do_nurbs_surface( GLUnurbs *nobj )
{
