...
void
call_user_error( GLUnurbs *nobj, GLenum error )
{
    nobj->error=error;
...
GLUnurbs * APIENTRY gluNewNurbsRenderer( void )
{
   ...
   n = (GLUnurbs *) malloc( sizeof(GLUnurbsObj) );
   if (n) {
      /* init */
      n->culling=GL_FALSE;
...
void APIENTRY gluLoadSamplingMatrices( GLUnurbs *nobj,
...
void APIENTRY gluNurbsCurve( GLUnurbs *nobj, GLint nknots, GLfloat *knot,
...
void APIENTRY gluNurbsSurface( GLUnurbs *nobj,
...
void APIENTRY
gluPwlCurve( GLUnurbs *nobj, GLint count, GLfloat *array, GLint stride,
    GLenum type)
{
#if 0
    nurbs_trim *ptr1;
