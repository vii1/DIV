...
#ifdef	MGL_FIX3D
/* {secret} */
ibool _MGL_clipCZLineFX(fix32_t *fx1,fix32_t *fy1,zfix32_t *fz1,
	fix32_t *fc1,fix32_t *fx2,fix32_t *fy2,zfix32_t *fz2,fix32_t *fc2,
	fix32_t left,fix32_t top,fix32_t right,fix32_t bottom)
/****************************************************************************
*
* Function:		_MGL_clipCZLineFX
