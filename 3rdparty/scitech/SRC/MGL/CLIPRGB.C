...
#ifdef	MGL_FIX3D
/* {secret} */
ibool _MGL_clipRGBLineFX(fix32_t *fx1,fix32_t *fy1,
	fix32_t *fr1,fix32_t *fg1,fix32_t *fb1,
	fix32_t *fx2,fix32_t *fy2,
	fix32_t *fr2,fix32_t *fg2,fix32_t *fb2,
	fix32_t left,fix32_t top,fix32_t right,fix32_t bottom)
/****************************************************************************
*
* Function:		_MGL_clipRGBLineFX
* Parameters:	x1,y1,c1	- First endpoint of line to clip
*				x2,y2,c2	- Second endpoint of line to clip
...
****************************************************************************/
{
	...
	fix32_t		x,y,r,g,b,dx,dy,dr,dg,db;
	...
	while (true) {
		...
		if (outcodeOut == outcode1) {
			x1 = x;	y1 = y; r1 = r; g1 = g; b1 = b;
			SETOUTCODES(outcode1,x,y);
			}
		else {
			x2 = x; y2 = y; r2 = r; g2 = g; b2 = b;
