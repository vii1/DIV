...
PRIVATE void GetInternalConstants(GTF_constants *c)
/****************************************************************************
*
...
PUBLIC void GTF_calcTimings(double hPixels,double vLines,double freq,
...
PUBLIC void GTF_getConstants(GTF_constants *constants)
{ *constants = GC; }

PUBLIC void GTF_setConstants(GTF_constants *constants)
{ GC = *constants; }
